...
<img src="docs/wordmark-swarm.png" alt="Swarm" height="72">
...
Swarm is a small, fast, entirely native app for controlling a Transmission daemon from your Mac —
...
<p align="center">
  <img src="docs/screenshot-main.png" alt="Swarm's torrent list" width="700">
</p>
<p align="center">
  <img src="docs/screenshot-inspector.png" alt="Swarm's torrent inspector" width="345">
  <img src="docs/screenshot-add-torrent.png" alt="Adding a torrent in Swarm" width="345">
</p>

> **Downloading a prebuilt copy?** Swarm isn't notarized yet, so macOS will flag it as
...
- Add via magnet link, `.torrent` file, or URL — make Swarm the default handler for both
...
No Xcode project — Swarm is a plain Swift package, built and packaged into a `.app` by one script:
...
Swarm isn't notarized yet — that needs a paid Apple Developer account — so on first launch
...
- Run `xattr -cr /Applications/Swarm.app` in Terminal to clear the quarantine flag.
...
xcrun notarytool submit dist/Swarm-1.0.dmg --keychain-profile "AC_PASSWORD" --wait
xcrun stapler staple dist/Swarm-1.0.dmg
```
