...
rm -rf "$APP_BUNDLE"; mkdir -p "$APP_MACOS" "$APP_RESOURCES"; cp "$BUILD_BINARY" "$APP_BINARY"; cp "$ROOT_DIR/Resources/Drift.png" "$APP_RESOURCES/Drift.png"; chmod +x "$APP_BINARY"
